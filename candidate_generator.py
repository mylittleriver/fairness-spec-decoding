...
class AssistedCandidateGenerator(CandidateGenerator):
    ...
    def __init__(
        ...
        # print("self.num_assistant_tokens in __init__(): ",self.num_assistant_tokens)
    ...
    def update_candidate_strategy(self, input_ids: torch.LongTensor, scores: torch.FloatTensor, num_matches: int):
        ...
        if self.assistant_model.generation_config.num_assistant_tokens_schedule in {
            ...
            if num_matches == int(self.num_assistant_tokens):
                # print("num_matches == int(self.num_assistant_tokens), self.num_assistant_tokens += 2.0")
                self.num_assistant_tokens += 2.0
            else:
                # print("num_matches != int(self.num_assistant_tokens), self.num_assistant_tokens = max(1.0, self.num_assistant_tokens - 1.0)")
